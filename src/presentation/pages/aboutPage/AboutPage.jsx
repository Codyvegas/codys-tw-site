  ...
  return (
    <div className="bg-slate-800">
      <div className="6meboxes m-auto flex w-6/12 flex-col justify-center">
        <div className="CONTAINER m-12 transform rounded-3xl border-2 border-solid border-purple-700 bg-black px-12 drop-shadow-xl ">
          <h1 className=" animate-pulse p-12 text-center text-3xl text-purple-500 underline blur-sm duration-500 ease-in-out hover:animate-none hover:blur-0">
            This is MY story!
          </h1>
        </div>
        ...
        <div className="m-12 rounded-3xl border-2 border-solid border-emerald-600 bg-black px-12 drop-shadow-xl">
          <p className=" animate-pulse p-12 text-center text-3xl	text-emerald-400 blur-sm duration-500 ease-in-out hover:animate-none hover:blur-0">
        ...
        <div className="m-12 rounded-3xl border-2 border-solid border-red-600 bg-black px-12 drop-shadow-xl">
