  ...
  return (
    <div className="landing-page bg-slate-700">
      <div className="m-auto flex w-6/12 flex-col	">
        <div className="my-24	 rounded-3xl border-2 border-solid border-cyan-700 bg-black/50 ">
          <h1 className="mt-12 mb-2 text-center text-2xl	text-cyan-400">
            Hi, Im Cody!
          </h1>
          ...
          <img
            className=" ml-20 mb-12	mt-6 rounded-3xl bg-gradient-to-r from-cyan-400 to-blue-800"
            src={headshot}
            alt="A picture of me!"
          ></img>
        </div>
