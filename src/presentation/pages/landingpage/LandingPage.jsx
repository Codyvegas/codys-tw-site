  ...
  return (
    <div className="landing-page bg-slate-700">
      <div className="m-auto flex w-6/12 justify-center">
        <div className="my-24 content-center rounded-3xl border-2 border-solid border-cyan-600 bg-black px-12 ">
          ...
          <img
            className=" mb-12 mt-6 scale-90 rounded-3xl	border-2 border-solid border-y-cyan-400 border-x-purple-500 bg-gradient-to-r from-cyan-400 to-blue-800"
            src={headshot}
            alt="A picture of me!"
          ></img>
        </div>
