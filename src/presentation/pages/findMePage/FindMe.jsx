  ...
  return (
    <div className="bg-slate-800">
      <div className="m-auto flex w-6/12 justify-center">
        <div className="my-24 rounded-3xl border-2 border-solid border-emerald-600 bg-black px-12 drop-shadow-xl">
          <h1 className=" mt-12 mb-4 text-center text-4xl	text-emerald-300 underline">
            Codys Code
          </h1>
          <div className="mb-12 mt-6 h-64 rounded-3xl border-4 border-solid border-y-cyan-400 border-x-purple-500 bg-slate-900 p-12 text-2xl">
            <div className="flex items-center hover:animate-pulse">
              <a
                ...
                target="_blank"
              >
                <img src={linkedin} className="m-auto mr-6 h-14"></img>
              </a>
              <a
            ...
            <div className="bottom container flex items-center hover:animate-pulse">
              <a href=" https://github.com/Codyvegas/ " target="_blank">
                <img
                  className=" m-auto mr-6 h-14 rounded-lg"
                  src={github}
                ></img>
              </a>
              <a
